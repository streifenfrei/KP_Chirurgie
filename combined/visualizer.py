...
class CSLVisualizer(Visualizer):
    def draw_instance_predictions(self, predictions):
        ...
        my_heatmap_tensor = predictions.pred_loc
        # added the output heatmap by huxi
        ...
        self.overlay_instances(
            ...
            labels=labels,
            keypoints=keypoints,
            my_heatmap_tensor = my_heatmap_tensor,
            assigned_colors=colors,
            alpha=alpha,
        )
        return self.output

    # === override the function: overlay_instances() === #
    # === add 1 more parameter: my_heatmap_tensor === #
    def overlay_instances(
        ...
        *,
        ...
        my_heatmap_tensor = my_heatmap_tensor.cpu().detach().numpy()
