...
from csl.data_loader import image_transform, image_transform_valid, OurDataLoader
...
def train_model(workspace, dataset, segmentation_loss, normalize_heatmap=False, batch_size=2, lambdah=default_lambdah,
                sigma=default_sigma, non_img_norm_flag=True, learning_rate=default_learning_rate):
...
def call_model(workspace, dataset):
...
if __name__ == '__main__':
    ...
    if args.command == 'init':
        ...
        train_model(args.workspace, args.dataset, segmentation_loss,
                    normalize_heatmap=args.normalize, batch_size=args.batch, lambdah=args.lambdah, sigma=args.sigma,
                    non_img_norm_flag=args.non_img_norm_flag, learning_rate=args.learningrate)
